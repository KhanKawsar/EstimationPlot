...
DurgaPlot(d, main = "Default display", ef.size.label = "")

d <- DurgaDiff(weight ~ group, damselfly, na.rm = TRUE,
               groups = c("Immature" = "juvenile", "Mature" = "adult"))
DurgaPlot(d, main = "Groups labelled and ordered", left.ylab = "", group.colour = "Set1")
```
