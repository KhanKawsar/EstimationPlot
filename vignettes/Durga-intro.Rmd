...
Repeated measures data may be in _wide format_, with repeated measures in separate columns of the same row. With wide data, you do not specify the `data.col` or `group.col` arguments to `DurgaDiff`. Instead, you must identify the groups (or treatments) in your data with the `groups` argument. Each group must be the name of a column in the data frame. 

```{r} 
# Inspect the wide insulin data set
head(insulin.wide[insulin.wide$id < 4, ])
